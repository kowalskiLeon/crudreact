...
import configs.BaseService;
import configs.GsonUtils;
import configs.PaginacaoDTO;
import configs.PojoBase;
import configs.RetornoPaginadoDTO;
...
public abstract class BaseRestController<T extends PojoBase> {

    protected BaseService<T> baseService;
    protected Class classe;
    protected Class<T[]> classes;

    public BaseRestController(BaseService<T> service, Class classe, Class<T[]> classes) {
    ...
    public T criarDtoDefault(T objeto) {
        if (objeto != null) {
            objeto.setExclusaoLogica(null);
            objeto.setModificacao(null);
        }
        return objeto;
    }
